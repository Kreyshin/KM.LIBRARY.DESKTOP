...
const sortOptions = [
  { value: 'works', label: 'Más obras' },
  { value: 'volumes', label: 'Más tomos' },
...
<template>
  <div class="authors-page">
    ...
    <div class="authors-toolbar">
      ...
      <PurpleSelect v-model="sortBy" :options="sortOptions" class="authors-sort" aria-label="Ordenar autores" compact />
...
.authors-sort{width:180px;flex:0 0 180px}@media(max-width:760px){.authors-sort{width:100%;flex:auto}}
</style>
